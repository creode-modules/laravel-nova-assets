...
class UploadAsset
{
     ...
     * @param integer $originalSize Original Size of the uploaded file.
     */
    public function __construct(protected string $relativePath, protected string $originalName, protected int $originalSize)
    {
    }
